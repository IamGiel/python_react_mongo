...
const publishingOptions = [
  {
    title: "Public",
    description: "This posting can be viewed by anyone regardless if they are registered user or not.",
    current: true,
  },
  {
    title: "Private",
    description: "This posting will no longer be publicly accessible.",
    current: false,
  },
];
